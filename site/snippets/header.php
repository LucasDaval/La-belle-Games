...
<body>
  <header class="header">
    <ul id="rs">
      <?php 
        ...
        for($i; $i<=7; $i++) : 
      ?>
        <li><a href="<?= $pages->files()->nth($i)->link() ?>" target="_blank"><img src="<?= $pages->files()->nth($i)->url() ?>" alt=""></a></li>
      <?php endfor ?>
    </ul>
  ...
  <nav>
    <ul>
      ...
      <li id="lbgNavBarre"><a href="<?= $site->children()->listed()->nth(0)->url() ?>"><img src="<?= $pages->files()->nth(8)->url()?>" alt=""></a></li>
